...
const Home = () => {
  return (
    <>
        ...
        <section id="hero" className="hero section dark-background">
          ...
          >
            ...
            <div className="carousel-item">
              ...
              <div className="carousel-container">
                <h2>We sell and rent farmland</h2>
              </div>
            </div>

            <div className="carousel-item">
              <img src="assets/img/tractors.jpg" alt="" />
              <div className="carousel-container">
                <h2>We sell and rent heavy equipment.</h2>
              </div>
            </div>

            <div className="carousel-item">
              <img src="assets/img/fertilizers.jpg" alt="" />
              <div className="carousel-container">
                <h2>We sell fertilizers and manure</h2>
              </div>
            </div>
        ...
        >
          <div className="row gy-4">
            <div className="col-lg-7 d-flex flex-column justify-content-center">
              <h1 data-aos="fade-up">
                {" "}
                Tractors at the best price and top performance
              </h1>
              <p data-aos="fade-up" data-aos-delay="100">
                Discover our range of tractors at the best price and top
                performance. Built for durability and efficiency, they handle
                all your farming needs. Whether you need power for plowing or
                hauling, we ve got you covered. Get quality machinery without
                breaking the bank contact us today!
              </p>
              <div
              ...
              >
                ...
                <a
                  href="https://www.youtube.com/watch?v=HI8Hc1BbnFc"
      ...
      {/* About Section - From index.html (and previous request) */}
      ...
      {/* About 3 Section - From index.html (and previous request) */}
          ...
          <div className="row gy-4 justify-content-between align-items-center">
            ...
            >
              <img
                ...
                className="img-fluid"
              />
              {/* Note: The GLightbox link will be initialized in App.js */}
              <a
                href="https://www.youtube.com/watch?v=onCumAiHPwg"
            ...
            >
              ...
              <p className="mb-4">
                Plants make life better by bringing beauty, calm, and fresh air
                to any space. They reduce stress, improve mood, and even clean
                the air we breathe. Whether in a garden or on a windowsill,
                their presence adds life and color. Start growing your
      ...
      {/* Services Section - From index.html (reused from services.html content if applicable, or placeholder) */}
      <section id="services" className="services section">
        ...
        <div className="content" style={{ flexWrap: "nowrap" }}>
          <div className="container">
            <div className="row g-0">
              <div className="col-lg-3 col-md-6" style={{ width: "20%" }}>
                <Link to="/products/heavy">
                  <div style={{ cursor: "pointer" }} className="service-item">
                    <span className="number">01</span>
                      ...
                      <div className="service-item-content">
                        <h3 className="service-heading">heavy equipment</h3>
                        <p>
                          We sell and rent heavy equipment for all your
                          agricultural and construction needs. Reliable
                          machines, affordable prices, and flexible rental
                          options available.
                        </p>
                      </div>
                    ...
                    <span className="number">02</span>
                      ...
                      <div className="service-item-content">
                        <h3 className="service-heading">
                          sell and rent farmland
                        </h3>
                        <p>
                          We sell and rent farmland for agriculture and
                          investment opportunities. Find the perfect land to
                          grow your future with flexible options and great
                          prices.
                        </p>
                      </div>
                ...
                <Link to="/products/manure">
                  <div className="service-item" style={{ cursor: "pointer" }}>
                    ...
                    <div className="service-item-content">
                      ...
                      <p>
                        We offer high-quality fertilizers and natural manure to
                        boost your crop growth. Give your soil the nutrients it
                        needs for a healthy and productive harvest.
                      </p>
                    </div>
                  </div>
                </Link>
                ...
                <Link to="/products/accessories">
                  <div className="service-item" style={{ cursor: "pointer" }}>
                    ...
                    <div className="service-item-content">
                      ...
                      <p>
                        We offer accessories to make your work easier. From
                        irrigation tools to protective gear, our products
              ...
              <div className="col-lg-3 col-md-6" style={{ width: "20%" }}>
                <Link to="/products/homemade">
                  <div className="service-item" style={{ cursor: "pointer" }}>
                    ...
                    <div className="service-item-content">
                      <h3 className="service-heading">Purely Homemade</h3>
                      <p>
                        Authentic products made with care and natural
                        ingredients. From jams to soaps, each item reflects
                        simple, homegrown craftsmanship.
                      </p>
                    </div>
                  </div>
                </Link>
